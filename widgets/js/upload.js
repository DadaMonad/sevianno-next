...
sevianno.registerIwcCallback("ADDED_TO_MPEG7", function(intent) {
  ...
  $("#vidnumber" + vidCounterTranscoded).text("Uploaded: " + name).click(function() {
...
},{"./autologin.coffee":1,"./sevianno.coffee":2,"dateformat":4}],4:[function(require,module,exports){
/*
 * Date Format 1.2.3
