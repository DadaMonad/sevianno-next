...
/*
login url:  'http://137.226.58.21:9080/ClViTra_2.0/rest/auth'
upload url: 'http://137.226.58.21:9080/ClViTra_2.0/rest/upload'
*/
...
},{"./autologin.coffee":1,"./sevianno.coffee":3}],3:[function(require,module,exports){
...
Sevianno = (function() {
  ...
  function Sevianno() {
    ...
    this.lasClient = new LasAjaxClient("sevianno", (function(_this) {
      return function(statusCode, message) {
        var _ref;
        console.log("Sevianno-Next statusCode received las: " + statusCode + "/" + (_.isString(message) ? message : void 0));
  ...
  Sevianno.prototype.lasInvocationHelper = function() {
    var callback, method, p, parameters, parametersJson, service, _i, _j, _len;
    service = arguments[0], method = arguments[1], parameters = 4 <= arguments.length ? __slice.call(arguments, 2, _i = arguments.length - 1) : (_i = 2, []), callback = arguments[_i++];
    ...
    for (_j = 0, _len = parameters.length; _j < _len; _j++) {
      ...
      } else if (_.isArray(p) && _.isEmpty(p) || _.isString(p[0])) {
        parametersJson.push({
          type: "String[]",
          value: p
        });
    ...
    return this.lasClient.invoke(service, method, parametersJson, callback);
  };

  Sevianno.prototype.getVideoInformation = function() {
    var callback, uri_s, uris, whereCondition;
    uris = null;
    uri_s = null;
    callback = null;
    switch (false) {
    ...
    switch (false) {
      case !_.isString(uri_s):
        uris = [uri_s];
        break;
      case !_.isArray(uri_s):
        uris = uri_s;
        break;
      default:
        throw new Error("Invalid arguments for this function");
    }
    if (uris.length > 0) {
      whereCondition = _.reduce(uris.slice(1), function(memo, url) {
        return memo.concat(" or $uri = '" + url + "'");
      }, "$uri = '" + uris[0] + "'");
    } else {
      whereCondition = "";
    }
